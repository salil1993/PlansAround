...
const PastEvents = ({navigation}) => {
  ...
  const getRequestedEvent = async () => {
      ...
      axios.get(`https://plansaround-backend.vercel.app/api/mobile/my-event/event-attended?page=1&limit=10`, { headers })
          .then((res) => {
  ...
  return (
      <WrapperContainer>
          ...
          <HeaderBack mainText='Past Event’s' style={{ backgroundColor: '#fff', paddingHorizontal: moderateScale(10) }} />
                          ...
                          <FlatList
                              ...
                              renderItem={({ item, index }) => {
                                  ...
                                  const handleViewDetails = () => {
                                     console.log("handleViewDetails------", item);
                                     navigation.navigate(navigationStrings.PAST_EVENTS_DETAILS, {item})
                                  };
                                  return (
                                      <>
